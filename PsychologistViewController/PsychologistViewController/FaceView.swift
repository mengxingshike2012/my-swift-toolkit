...
class FaceView: UIView {
    ...
    private func bezierPathForEye(whichEye: Eye) -> UIBezierPath {
        let eyeRadis = faceRadius / Scaling.FaceRadiusToEyeRadisRatio
        ...
        let path = UIBezierPath(arcCenter: eyeCenter, radius: eyeRadis, startAngle: 0, endAngle: CGFloat(2*M_PI), clockwise: true)
